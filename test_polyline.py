...
def test_polygon_init_with_list():
    """You can instantiate a Polyline with a list of points (one argument)"""
    points = [(0, 0), (5, 0), (5, 5), (5, 10), (10, 10)]
    path1 = Polyline(points)
    path2 = Polyline(*points)
    assert path1 == path2


def test_polygon_init_with_polygon():
    """You can instantiate a Polyline with another Polyline instance"""
    points = [(0, 0), (5, 0), (5, 5), (5, 10), (10, 10)]
    path1 = Polyline(points)
    path2 = Polyline(path1)
    assert path1 == path2
...
def test_polygon_replace_part1():
    """A single line segment that is given as a replacement will be part of the new Polyline"""
...
def test_polygon_replace_part_replaces():
    """The segments that shall be replaced are not in the resulting Polyline"""
    points = [(0, 0), (0, 5), (0, 10), (10, 10), (10, 5), (10, 0)]
    path = Polyline(*points)
    new_points = [(0, 5), (10, 5)]
    # replace the "bottom" part of the path with the line across the middle ((0,5), (10,5))
